...
def set_md_from_pulse_schedule(bundle):
    ...
    ec_launchers0 = copy.deepcopy(bundle['ec_launchers'])
    ...
    for aj in range(len(ec_launchers0.antenna)):
        ec_launchers0.launcher[aj].frequency.data =      pulse_schedule0.ec.antenna[0].frequency.reference.data
        ec_launchers0.launcher[aj].power_launched.data = pulse_schedule0.ec.antenna[0].power.reference.data/3
    ...
    IDS_BUNDLE['nbi'] = nbi0
    IDS_BUNDLE['ec_launchers'] = ec_launchers0
