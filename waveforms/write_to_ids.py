def write_to_ids(sys_dict, param,source ): #, ntime_slices, t_begin, t_end):
    ...
    def set_ec(ec_dict_temp):
        ...
        for iant in ec_dict_temp:
                ...
                output.ec_antennas.antenna[i].beam.phase.curvature.data = ec_dict_temp[iant]['beam_phase_curvature']
    ...
    if source == 'ic':
        ...
        print('saved ic waveform configuration')
