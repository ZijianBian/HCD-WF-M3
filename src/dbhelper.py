...
class DbHelper:
    def __init__(self, input_user_or_path, input_database, output_user_or_path, output_database, shot_number, input_run, output_run):
    ...
    def getMachineDatabase(self):
        machineDb = imas.DBEntry(imas.imasdef.MEMORY_BACKEND,self.output_database,0,self.output_run,self.output_user_or_path)
        machineDb.create()
        return machineDb