...
def connect_labels(canvas, w1, dir1, w2, dir2, arrow_yn, l, nrl):
    ...
    if ((dir1 == 'n' or dir1 == 's') and (dir2 == 'e' or dir2 == 'w')) \
       or ((dir1 == 'e' or dir1 == 'w') and(dir2 == 'n' or dir2 == 's')):
        canvas.create_line(line_start_x, line_start_y,
                           line_start_x, line_end_y,
                           line_end_x, line_end_y, 
                           width = 2, arrow = arrow_yn, fill =col.c5)
...
def merge_bottom_lines(label_n, inv_i, mergefr, labelrow):
        ...
        mergefr.create_line(line_start_x, line_start_y,
                            ...
                            line_end_x, line_start_y + dy/2,
                            line_end_x, line_end_y,
                            width = 2, arrow = None, fill =col.c5)
...
def mergefr_draw_lines(inv_n, label_n, color_line, mergefr, labelrow):
    ...
    mergefr.create_line(line_start_x, line_start_y, line_end_x, line_end_y, \
                        width = 2, arrow = None, fill = color_line)
